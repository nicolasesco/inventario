				...
				<form name="edit_product" id="edit_product">
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							...
							<input type="text" readonly="readonly" name="edit_category" id="edit_category" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Proveedor</label>
							<input type="text" name="edit_proveedor" id="edit_proveedor" class="form-control">

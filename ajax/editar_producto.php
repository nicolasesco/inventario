<?php
	...
	$proveedor = mysqli_real_escape_string($con,(strip_tags($_POST["edit_proveedor"],ENT_QUOTES)));
	$stock = floatval($_POST["edit_stock"]);
	$price = intval($_POST["edit_price"]);
	
	$id=intval($_POST['edit_id']);
	// UPDATE data into database
    $sql = "UPDATE tblprod SET prod_code='".$prod_code."', prod_name='".$prod_name."', prod_ctry='".$prod_ctry."', proveedor='".$proveedor."', price='".$price."',  preciocosto='".$stock."' WHERE id='".$id."' ";
